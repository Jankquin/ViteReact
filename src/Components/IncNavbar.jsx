                ...
                {/* <div className="container mx-auto pt-2">
                    <div className="flex justify-center">
                        <div className="lg:w-5/12 md:w-8/12 w-full flex overflow-x-scroll mx-auto no-scrollbar"> 
                            <Link to="/" className="hover:bg-slate-100 text-slate-600 text-sm rounded-sm mr-2 px-3 py-1 whitespace-nowrap">Recomended</Link>
                            <Link to="/more" className="hover:bg-slate-100 text-slate-600 text-sm rounded-sm mr-2 px-3 py-1 whitespace-nowrap">Genre</Link>
                            <Link to="/more" className="hover:bg-slate-100 text-slate-600 text-sm rounded-sm mr-2 px-3 py-1 whitespace-nowrap">Most View</Link>
                        </div>
                    </div>
                </div> */}
            </div>
