                        ...
                        <div className="lg:w-5/12 md:w-8/12 w-full">
                            <form className="bg-slate-200/50 relative">
                                {LabelSearch ? 
                                    ...
                                    : 
                                    <div className="absolute flex text-slate-800 h-full w-full z-30" onClick={ModalSearchClose}>
                                        <button className="ml-auto self-center p-3">
                                            <i className="bi-x"></i>
                                        </button>
                                    </div>
                                }
                                <input className="bg-transparent text-slate-800 text-sm font-medium relative outline-none w-full z-10 p-3" type="text" value={Search} onChange={Filter}/>
                            </form>
                        </div>
